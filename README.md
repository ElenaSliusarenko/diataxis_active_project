...
**🎯 New here?** Jump straight to the **[Mobile_Nutrition_App/](./Mobile_Nutrition_App/)** — the active project documented using the Diataxis framework.
...
**Want to see Diataxis in practice?** Check out the **[Mobile_Nutrition_App/](./Mobile_Nutrition_App/)** folder — an active project documented using the Diataxis framework.
...
**👉 [Open the Mobile Nutrition App →](./Mobile_Nutrition_App/README.md)**
...
The `/Mobile_Nutrition_App/` folder contains the active project documentation demonstrating Diataxis principles in practice:
...
**Start here**:
- `Mobile_Nutrition_App/README.md` - Project overview and structure
- `Mobile_Nutrition_App/GETTING_STARTED.md` - Quick onboarding guide
- `Mobile_Nutrition_App/PROJECT_OVERVIEW.md` - Detailed project information
...
- For a complete project example, see `/Mobile_Nutrition_App/` — active project documentation
...
*Repository Maintainer: Elena Sliusarenko*
