...
- Replace template placeholders like `[language]` in code fences with an actual language (e.g., `bash`, `javascript`, `sql`, `text`).
- For pseudocode, CLI transcripts, logs, or ASCII diagrams, use `text` as the code block language (do not leave it empty).
